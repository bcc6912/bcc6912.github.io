...
function sortCards(list) {
    if (searchOrder[0].value == "Select Order" || searchOrder[0].value == "Name (A-Z)") {
        list.sort();
    } else if (searchOrder[0].value == "Name (Z-A)") {
        list.sort();
        list.reverse();
    } else if (searchOrder[0].value == "Challenge (Low-High)") {
        list.sort(function (obj1, obj2) {return eval(obj1.challenge_rating) - eval(obj2.challenge_rating)});
    } else if (searchOrder[0].value == "Challenge (High-Low)") {
        list.sort(function (obj1, obj2) {return eval(obj2.challenge_rating) - eval(obj1.challenge_rating)});
    }
    return list;
}
